...
function Project(){
  ...
  useEffect(() => {
    const projects = [
      {id:"1",title:"Messaging App",frontend:"https://messagingapp-deploy.onrender.com",desc:"Real time Messaging App",demo:"https://res.cloudinary.com/dnvwzsyue/video/upload/v1738685778/MessageAppRecording_ylmzpl.mov",challenges:"integrating websockets",techUsed:"Django Channels, Django",features:"send,receive, update messages in real-time",viewCode:"https://github.com/lyepez-glitch/MessagingApp",backend:"https://messagingapp-deploy.onrender.com"},
      ...
      {id:"8",title:"BioAgeCompanion",frontend: "https://bio-age-frontend.vercel.app/",backend:"https://bioage-companion.onrender.com/api/",desc:"Input vitals and calculate biological age and health recommendations",demo:"https://res.cloudinary.com/dnvwzsyue/video/upload/v1738683935/BioAgeCompanion_lexc0d.mov",challenges:"react native",techUsed:"python",features:"Input vitals and calculate biological age and health recommendations",viewCode:["https://github.com/lyepez-glitch/BioAge-Companion-"]}
