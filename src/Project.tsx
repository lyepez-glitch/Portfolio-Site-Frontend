...
function Project(){
  ...
  useEffect(() => {
    const projects = [
      {id:"1",title:"Messaging App",frontend:"https://messagingapp-deploy.onrender.com",desc:"Real time Messaging App",demo:"/recordings/MessageAppRecording.mov",challenges:"integrating websockets",techUsed:"Django Channels, Django",features:"send,receive, update messages in real-time",viewCode:"https://github.com/lyepez-glitch/MessagingApp",backend:"https://messagingapp-deploy.onrender.com"},
          ...
          <ul className="card">
            ...
            <li>Live demo:
              <video width="320" height="240" controls>
                <source src={proj.demo} type="video/quicktime" />
